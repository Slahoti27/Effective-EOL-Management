...
class Juniper_Scraper:
    """Juniper Scraper Class"""

    url = "https://relutech.com/eol-eosl/juniper/?orderby=date-asc"
...
scraper = Juniper_Scraper()
scraper.eol_data_generator(scraper.url, "CSV\SW\Juniper.csv")