...
class Lenovo_Scraper:
    """Lenovo Scraper Class"""

    url = "https://relutech.com/eol-eosl/lenovo/?orderby=date-asc"
...
scraper = Lenovo_Scraper()
scraper.eol_data_generator(scraper.url, "CSV\HW\Lenovo.csv")