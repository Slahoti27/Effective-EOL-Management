...
class NetApp_Scraper:
    """NetApp Scraper Class"""

    url = "https://relutech.com/eol-eosl/netapp/?orderby=date-asc"
...
scraper = NetApp_Scraper()
scraper.eol_data_generator(scraper.url, r"CSV\HW\NetApp.csv")