...
class Sun_Oracle_Scraper:
    """Sun Oracle Scraper Class"""

    url = "https://relutech.com/eol-eosl/sun-oracle/?orderby=date-asc"
...
scraper = Sun_Oracle_Scraper()
scraper.eol_data_generator(scraper.url, "CSV\HW\Sun Oracle.csv")