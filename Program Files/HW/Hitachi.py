...
class Hitachi_Scraper:
    """Hitachi Scraper Class"""

    url = "https://relutech.com/eol-eosl/hitachi/?orderby=date-asc"
...
scraper = Hitachi_Scraper()
scraper.eol_data_generator(scraper.url, "CSV\HW\Hitachi.csv")